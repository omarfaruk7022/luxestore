  ...
  return (
    <div className="space-y-6 w-full">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={openCreate}
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-foreground text-background text-sm font-medium hover:opacity-90 transition-opacity cursor-pointer"
        >
            ...
            <tbody className="divide-y">
              {isLoading
                ...
                : categories.map((cat) => (
                    ...
                    >
                      <td className="py-3 px-3 md:px-4 first:pl-4 md:first:pl-6 font-medium whitespace-nowrap">
                        {cat.name}
                      </td>
                      <td className="py-3 px-3 md:px-4 font-mono text-[10px] md:text-xs text-muted-foreground whitespace-nowrap">
                        {cat.slug}
                      </td>
                      <td className="py-3 px-3 md:px-4 text-muted-foreground max-w-[120px] md:max-w-xs truncate">
                        {cat.description || "—"}
                      </td>
            ...
            >
              <div className="flex items-center justify-between p-6 border-b">
                ...
                <button
                  ...
                  className="p-2 rounded-full hover:bg-secondary cursor-pointer"
                >
                  <X size={16} />
                </button>
              </div>
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    type="button"
                    onClick={() => setShowForm(false)}
                    className="flex-1 py-3 rounded-xl border text-sm font-medium hover:bg-secondary transition-colors cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={saving}
                    className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-foreground text-background text-sm font-medium hover:opacity-90 disabled:opacity-50 cursor-pointer"
                  >
                    <Check size={14} />
