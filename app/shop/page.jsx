          ...
          <div className="flex-1 min-w-0">
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 text-center">
                <p className="font-display text-3xl font-light mb-2">
                  No products found
                </p>
                ...
                <button
                  onClick={clearFilters}
                  className="mt-4 px-6 py-2.5 rounded-full border text-sm font-medium hover:bg-secondary transition-colors"
                >
                  Clear Filters
                </button>
              </div>
