          ...
          <div className="text-center mb-8">
            <Link href="/" className="inline-block mb-6">
              <div className="w-12 h-12 rounded-full bg-foreground flex items-center justify-center mx-auto">
                <span className="text-background font-display text-lg font-bold">L</span>
              </div>
            </Link>
            <h1 className="font-display text-3xl font-light">Create account</h1>
            <p className="text-muted-foreground text-sm mt-2">Join LuxeWear for premium comfort</p>
          </div>
